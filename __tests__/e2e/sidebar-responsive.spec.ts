...
test.describe("Responsive sidebar", () => {
  test("mobile: hamburger menu should open and close the sidebar", async ({ page }) => {
  ...
  test("desktop: hamburger menu should be hidden and content should be visible", async ({ page }) => {
